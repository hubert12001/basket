...
export const scheduler = {
    advertise: '📢 AceCartel 👑 https://discord.gg/uYnwMD7QdF'
...
export const command = {
    ...
    ,helpman: { // detailed description for a command
        ...
        ,afk: '📑 !afk switches to idle status.You might be kicked if sleep too long.'
    ...
    ,super: {
        ...
        ,defaultMessage: '📄 Super admin system for control bot in the game.'
    ...
    ,scout: {
        ...
        ,scouting: '📊 Expectation : Red {teamExpectationRed}%, Blue {teamExpectationBlue}%, Spec {teamExpectationSpec}%.'
    }
    ,vote: {
